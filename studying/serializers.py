...
from .models import Testing, MatchTask, MultiChoiceQuestion, Choice, MatchQuestion, TFTask, TFStatement, WordBoxTask, Sentence
...
class TestingSerializer(serializers.ModelSerializer):
    ...
    tf_tasks = TFTaskSerializer(many=True, read_only=True)
